      ...
      $.ajax({
        ...
        success: function(cData){
          if(cData.status == null){
            ...
            $('#common').append("<div class='col-md-4'><div class='thumbnail'><img src="+cData.logo+"><div class='caption'><h3><a href="+cData.url+">"+cData.name+"</a></h3><p>Status: <em>"+cData.status+"</em></p></div></div></div>");
            // console.log(cData);
          }
        }
      });
